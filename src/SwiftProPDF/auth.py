...
def ensure_admin_exists(connection) -> None:
...
def prune_expired_user_sessions(connection: object, now: datetime | None = None) -> None:
    if now is None:
        now = utc_now()
...
def user_to_dict(user) -> dict[str, str | int | bool | None]:
